...
import { Avatar, Badge, Button, Collapse, Container, IconButton, Menu, MenuItem, TextField, Toolbar, Typography } from "@mui/material";
            ...
            {token && url === false ? (
              <Box>
                <Box sx={{ display: { xs: "flex", md: "none", lg: "none" } }}>
                  ...
                  >
                    <MenuItem onClick={handleCloses}>Home</MenuItem>
                    <MenuItem onClick={handleCloses}>Messages</MenuItem>
                    <MenuItem onClick={handleCloses}>Notifications</MenuItem>
                    <MenuItem onClick={handleCloses}>Jobs</MenuItem>
                    <MenuItem onClick={handleCloses}>Post a job</MenuItem>
